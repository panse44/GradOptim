# A function to calculate the estimates of the standard error for each of the dependent variable
# used in the regression task which is passed as an argument to the function.It uses the Batch
# Gradient descent optimization technique for each iteration of the bootstrapping sample to
# estimate the coefficients.

BGD.Logistic.Boot = function(train.Y,train.X,alpha=0.001,tolerance=0.01)
{
  col=ncol(train.X)
