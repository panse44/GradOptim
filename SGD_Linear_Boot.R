...
# It uses the Mini Batch Gradient descent optimization technique for each iteration 
# of the bootstrapping sample to estimate the coefficients

SGD_Linear_Boot <- function(train.Y,train.X,alpha=0.001,tolerance=0.01)
{
  col=ncol(train.X)
